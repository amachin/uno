...
On older versions, you need to use the HttpHandler provided by Uno.UI.WebAssembly. See [example](https://github.com/unoplatform/Uno.Samples/blob/master/UI/TheCatApiClient/TheCatApiClient/TheCatApiClient.Shared/WebServices/WebApiBase.cs#L18).
